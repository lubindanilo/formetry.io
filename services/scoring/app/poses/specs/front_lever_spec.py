...
SYMMETRY_METRICS = [
    MetricDefinition("shoulder_height_symmetry", score_pair_height_symmetry, ("LEFT_SHOULDER", "RIGHT_SHOULDER"), {"left_name": "LEFT_SHOULDER", "right_name": "RIGHT_SHOULDER", "tolerance_ratio": 0.07, "max_ratio": 0.28}, 0.25),
    MetricDefinition("hip_height_symmetry", score_pair_height_symmetry, ("LEFT_HIP", "RIGHT_HIP"), {"left_name": "LEFT_HIP", "right_name": "RIGHT_HIP", "tolerance_ratio": 0.07, "max_ratio": 0.28}, 0.25),
...
LOCKOUT_EXTENSION_METRICS = [
    MetricDefinition("left_elbow_lockout", score_elbow_lockout, ("LEFT_SHOULDER", "LEFT_ELBOW", "LEFT_WRIST"), {"side": "LEFT"}, 0.10),
    MetricDefinition("right_elbow_lockout", score_elbow_lockout, ("RIGHT_SHOULDER", "RIGHT_ELBOW", "RIGHT_WRIST"), {"side": "RIGHT"}, 0.10),
